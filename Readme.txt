Alle subtasks er løst i hennhold til kravene i mappen. Prosjektet har egne klasser for de forskjellige effektene som skulle lages. Prosjektet har følgende effekter:
...
Konstant maximum traversal depth er byttet ut med color contribution system hvor hver ray har en color contribution verdi. Når verien når 0.02(2%) eller mindre avsluttes raytracing og svart farge returneres for den gjeldende rayen.
